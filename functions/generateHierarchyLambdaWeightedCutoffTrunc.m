function [ado_indices,ado_gammas,lower_indices,upper_indices,coupled_mode_indices,truncated_coupled_modes,ado_indices_term,modes_term,term_indices] = generateHierarchyLambdaWeightedCutoffTrunc(L_cut,p,nus,cs,lambdas)
...
mode_weights = (abs(nus) ./abs(lambdas)) ;
