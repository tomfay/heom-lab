function [ado_indices,ado_gammas,lower_indices,upper_indices,coupled_mode_indices,truncated_coupled_modes] = generateHierarchyFreqTrunc(gamma_max,nus)
...
for L = 1:L_max
   ...
   for k = 1:n_modes
       for r = 1:n_lower
          ...
          is_below_gamma_max = (gamma_ado<gamma_max) ;
          % if it is a new index set, add it to the list and store the
          % coupling
          if ((~is_member) & is_below_gamma_max)
