function [ado_indices,ado_gammas,lower_indices,upper_indices,coupled_mode_indices,truncated_coupled_modes] = generateHierarchyWeightedCutoff3Trunc(L_cut,nus,cs)
...
for L = 1:L_max
   ...
   for k = 1:n_modes
       for r = 1:n_lower
          ...
          cutoff_func = sum(sqrt(ado_indices_new.*mode_weights)) ;
          is_included = (cutoff_func<(sqrt(L_cut))) ;
