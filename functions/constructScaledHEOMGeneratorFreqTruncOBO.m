function [L_heom,ado_indices] = constructScaledHEOMGeneratorFreqTruncOBO(H_sys,V,gamma_Bs,lambda_Bs,Omega_Bs,beta,Gamma_cut)
...
[nus_array,cs_array] = generateNusAndCsOBO(gamma_Bs,lambda_Bs,Omega_Bs,beta,M) ;
