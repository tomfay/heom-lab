function [L_heom,ado_indices] = constructScaledHEOMGeneratorWeightedCutoff(H_sys,V,gamma_Ds,lambda_Ds,beta,L_cut)

% first find the maximum M, highest Matsubara mode to be treated explicitly
% given the value of Gamma_cut & beta
M = findMaxMjWeightedCutoff(L_cut,gamma_Ds, lambda_Ds,beta) ;
...
[ado_indices,ado_gammas,lower_indices,upper_indices,coupled_mode_indices,truncated_coupled_modes] = generateHierarchyWeightedCutoff3Trunc(L_cut,nus,cs);
